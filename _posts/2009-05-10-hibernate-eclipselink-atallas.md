...
<span style="white-space: nowrap;">`hibernate-entitymanager.jar`</span> és az összes függőségeik), addig nagyon
szimpatikus az EclipseLink-ben, hogy csak az `eclipselink.jar`-t kellett
bemásolni.
...
következő kapcsolót: 
<span style="white-space: nowrap;">`-javaagent:lib/spring-agent.jar`</span>.
...
csomag](https://docs.oracle.com/javase/6/docs/api/java/lang/instrument/package-summary.html)
dokumentációjában található. Az agent egy JAR állomány, ami a
manifest-ben tartalmaz egy <span style="white-space: nowrap;">`Premain-Class`</span>
bejegyzést, mely egy osztályra
...
állományt kell megadni (akár több <span style="white-space: nowrap;">`-javaagent`</span> kapcsolót is megadhatunk),
...
kell implementálni. Ilyenkor a `manifest.mf` fájlban az `Agent-Class`
...
Mindkét metódus opcionálisan megkaphat egy `Instrumentation` példányt.
...
EclipseLink-ben](https://wiki.eclipse.org/Introduction_to_EclipseLink_Application_Development_%28ELUG%29#Using_Weaving)
