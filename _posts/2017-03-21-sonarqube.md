...
<a href="/artifacts/posts/2017-03-21-sonarqube/project.png" class="glightbox">![Project](/artifacts/posts/2017-03-21-sonarqube/project_600.png)</a>

<!-- more -->

## Felépítése

Először nézzük meg a SonarQube [architektúráját](https://docs.sonarsource.com/sonarqube-cloud/architecture).
...
ökoszisztémába, ezért úgy döntöttek, hogy újraírják az azokban szereplő szabályok egy
...
Plugin verziószámát fixálni. Ezek a konfigurációs lehetőségek megtalálhatóak a [Maven Plugin dokumentációjában](https://docs.sonarsource.com/sonarqube-server/analyzing-source-code/scanners/sonarscanner-for-maven). Az elemzés is külön konfigurálható,
a paraméterek dokumentációja megtalálhatóak a [Analysis Parameters](https://docs.sonarsource.com/sonarqube-server/analyzing-source-code/analysis-parameters) dokumentációban.
...
<a href="/artifacts/posts/2017-03-21-sonarqube/issues.png" class="glightbox">![Issues](/artifacts/posts/2017-03-21-sonarqube/issues_600.png)</a>

<a href="/artifacts/posts/2017-03-21-sonarqube/source.png" class="glightbox">![Source](/artifacts/posts/2017-03-21-sonarqube/source_600.png)</a>
...
Ezért a [SonarQube fejlesztői szerint se](https://www.sonarsource.com/blog/why-you-shouldnt-use-build-breaker/) törje meg a buildet a Quality Gate, hanem inkább használjunk erre
